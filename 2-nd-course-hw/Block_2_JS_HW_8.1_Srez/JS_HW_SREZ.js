////Zadacha 1 ==============================================================================
// Создайте функцию, которая принимает строку и один символ и возвращает целое число, равное количеству вхождений 2-го аргумента, найденного в первом. Если не удается найти ни одного вхождения, должно быть возвращено значение, равное 0.
